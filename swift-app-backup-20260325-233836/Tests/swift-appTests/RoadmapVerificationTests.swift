...
struct CopywritingVerificationTests {
    ...
    func loadingCopyEllipsis() {
        let all = [
            ...
            LoadingCopy.assets, LoadingCopy.bitcoinExtras, LoadingCopy.swap,
    ...
    func emptyStateCopyCompleteness() {
        let all = [
            ...
            EmptyStateCopy.customAssets, EmptyStateCopy.swaps,
            EmptyStateCopy.staking, EmptyStateCopy.bitcoinExtras,
