...
final class WebSocketPriceStream: ObservableObject {
    ...
    func connect() {
        ...
        // CoinCap WebSocket API is defunct (DNS no longer resolves) — skip connection
        #if DEBUG
        print("WebSocketPriceStream: CoinCap WebSocket unavailable, skipping")
        #endif
    }
...
final class MempoolMonitor: ObservableObject {
    ...
    private func fetchTransactionStatus(txHash: String, chainId: String) async throws -> (String, Int) {
        ...
        case "bitcoin", "bitcoin-mainnet", "bitcoin-testnet":
            return try await fetchBitcoinTxStatus(txHash: txHash, testnet: chainId.contains("testnet"))
        case "ethereum", "ethereum-mainnet", "ethereum-sepolia":
            return try await fetchEthereumTxStatus(txHash: txHash, testnet: chainId.contains("sepolia"))
        case "litecoin":
            return try await fetchLitecoinTxStatus(txHash: txHash)
        case "bnb", "bsc-mainnet":
            return try await fetchEVMTxStatus(txHash: txHash, rpcURL: "https://bsc-dataseed.binance.org")
        case "polygon", "polygon-mainnet":
            return try await fetchEVMTxStatus(txHash: txHash, rpcURL: "https://polygon-rpc.com")
        case "arbitrum", "arbitrum-mainnet":
            return try await fetchEVMTxStatus(txHash: txHash, rpcURL: "https://arb1.arbitrum.io/rpc")
        case "optimism", "optimism-mainnet":
            return try await fetchEVMTxStatus(txHash: txHash, rpcURL: "https://mainnet.optimism.io")
        case "base", "base-mainnet":
            return try await fetchEVMTxStatus(txHash: txHash, rpcURL: "https://mainnet.base.org")
        case "avalanche", "avalanche-mainnet":
            return try await fetchEVMTxStatus(txHash: txHash, rpcURL: "https://api.avax.network/ext/bc/C/rpc")
        case "fantom", "fantom-mainnet":
            return try await fetchEVMTxStatus(txHash: txHash, rpcURL: "https://rpcapi.fantom.network")
        case "gnosis", "gnosis-mainnet":
            return try await fetchEVMTxStatus(txHash: txHash, rpcURL: "https://rpc.gnosischain.com")
        case "scroll", "scroll-mainnet":
            return try await fetchEVMTxStatus(txHash: txHash, rpcURL: "https://rpc.scroll.io")
        default:
            return ("unknown", 0)
        }
    }
    ...
    /// Generic EVM tx status check for L2/sidechain RPCs
    private func fetchEVMTxStatus(txHash: String, rpcURL: String) async throws -> (String, Int) {
    ...
    private func requiredConfirmations(for chainId: String) -> Int {
        switch chainId {
        case "bitcoin", "bitcoin-mainnet", "bitcoin-testnet": return 3
        case "ethereum", "ethereum-mainnet", "ethereum-sepolia": return 12
        case "litecoin": return 6
        case "bnb", "bsc-mainnet": return 15
           case "polygon", "polygon-mainnet": return 20
           case "arbitrum", "arbitrum-mainnet", "optimism", "optimism-mainnet", "base", "base-mainnet",
               "avalanche", "avalanche-mainnet", "fantom", "fantom-mainnet", "gnosis", "gnosis-mainnet", "scroll", "scroll-mainnet": return 12
        case "solana", "solana-mainnet", "solana-devnet": return 1
        case "xrp", "xrp-mainnet", "xrp-testnet": return 1
        default: return 1
        }
    }
    ...
    private func estimatedTime(for chainId: String) -> TimeInterval {
        switch chainId {
        case "bitcoin", "bitcoin-mainnet", "bitcoin-testnet": return 30 * 60
        case "ethereum", "ethereum-mainnet", "ethereum-sepolia": return 3 * 60
        case "litecoin": return 15 * 60
        case "bnb", "bsc-mainnet": return 45 // ~3s blocks * 15 confs
           case "polygon", "polygon-mainnet": return 40 // ~2s blocks * 20 confs
           case "arbitrum", "arbitrum-mainnet", "optimism", "optimism-mainnet", "base", "base-mainnet",
               "avalanche", "avalanche-mainnet", "fantom", "fantom-mainnet", "gnosis", "gnosis-mainnet", "scroll", "scroll-mainnet": return 60
        case "solana", "solana-mainnet", "solana-devnet": return 5
        case "xrp", "xrp-mainnet", "xrp-testnet": return 4
    ...
    private func notifyConfirmation(tx: PendingTransaction) async {
        ...
        content.body = "Your \(chainDisplayName(for: tx.chainId)) transaction has been confirmed"
    ...
    private func chainDisplayName(for chainId: String) -> String {
        switch chainId {
        ...
        case "polygon", "polygon-mainnet": return "Polygon"
        case "arbitrum", "arbitrum-mainnet": return "Arbitrum"
        case "optimism", "optimism-mainnet": return "Optimism"
        case "base", "base-mainnet": return "Base"
        case "avalanche", "avalanche-mainnet": return "Avalanche"
        case "fantom", "fantom-mainnet": return "Fantom"
        case "gnosis", "gnosis-mainnet": return "Gnosis"
        case "scroll", "scroll-mainnet": return "Scroll"
...
final class OfflineManager: ObservableObject {
    ...
    private func broadcastTransaction(signedTx: String, chainId: String) async throws {
        ...
        case "ethereum-sepolia":
            url = URL(string: "https://ethereum-sepolia-rpc.publicnode.com")!
            let jsonBody: [String: Any] = [
                "jsonrpc": "2.0",
                "method": "eth_sendRawTransaction",
                "params": [signedTx],
        ...
        case "bnb", "bsc-mainnet":
            url = URL(string: "https://bsc-dataseed.binance.org")!
            let jsonBody: [String: Any] = ["jsonrpc": "2.0", "method": "eth_sendRawTransaction", "params": [signedTx], "id": 1]
            body = try JSONSerialization.data(withJSONObject: jsonBody)
            
        case "polygon", "polygon-mainnet":
            url = URL(string: "https://polygon-rpc.com")!
            let jsonBody: [String: Any] = ["jsonrpc": "2.0", "method": "eth_sendRawTransaction", "params": [signedTx], "id": 1]
            body = try JSONSerialization.data(withJSONObject: jsonBody)
            
        case "arbitrum", "arbitrum-mainnet":
            url = URL(string: "https://arb1.arbitrum.io/rpc")!
            let jsonBody: [String: Any] = ["jsonrpc": "2.0", "method": "eth_sendRawTransaction", "params": [signedTx], "id": 1]
            body = try JSONSerialization.data(withJSONObject: jsonBody)
            
        case "optimism", "optimism-mainnet":
            url = URL(string: "https://mainnet.optimism.io")!
            let jsonBody: [String: Any] = ["jsonrpc": "2.0", "method": "eth_sendRawTransaction", "params": [signedTx], "id": 1]
            body = try JSONSerialization.data(withJSONObject: jsonBody)
            
        case "base", "base-mainnet":
            url = URL(string: "https://mainnet.base.org")!
            let jsonBody: [String: Any] = ["jsonrpc": "2.0", "method": "eth_sendRawTransaction", "params": [signedTx], "id": 1]
            body = try JSONSerialization.data(withJSONObject: jsonBody)
            
        case "avalanche", "avalanche-mainnet":
            url = URL(string: "https://api.avax.network/ext/bc/C/rpc")!
            let jsonBody: [String: Any] = ["jsonrpc": "2.0", "method": "eth_sendRawTransaction", "params": [signedTx], "id": 1]
            body = try JSONSerialization.data(withJSONObject: jsonBody)
            
        case "fantom", "fantom-mainnet":
            url = URL(string: "https://rpcapi.fantom.network")!
            let jsonBody: [String: Any] = ["jsonrpc": "2.0", "method": "eth_sendRawTransaction", "params": [signedTx], "id": 1]
            body = try JSONSerialization.data(withJSONObject: jsonBody)
            
        case "gnosis", "gnosis-mainnet":
            url = URL(string: "https://rpc.gnosischain.com")!
            let jsonBody: [String: Any] = ["jsonrpc": "2.0", "method": "eth_sendRawTransaction", "params": [signedTx], "id": 1]
            body = try JSONSerialization.data(withJSONObject: jsonBody)
            
        case "scroll", "scroll-mainnet":
            url = URL(string: "https://rpc.scroll.io")!
            let jsonBody: [String: Any] = ["jsonrpc": "2.0", "method": "eth_sendRawTransaction", "params": [signedTx], "id": 1]
            body = try JSONSerialization.data(withJSONObject: jsonBody)
            
        case "solana-mainnet", "solana":
            url = URL(string: "https://api.mainnet-beta.solana.com")!
            let jsonBody: [String: Any] = ["jsonrpc": "2.0", "method": "sendTransaction", "params": [signedTx], "id": 1]
            body = try JSONSerialization.data(withJSONObject: jsonBody)
        ...
        case "xrp-mainnet", "xrp":
            url = URL(string: "https://s1.ripple.com:51234")!
            let jsonBody: [String: Any] = ["method": "submit", "params": [["tx_blob": signedTx]]]
            body = try JSONSerialization.data(withJSONObject: jsonBody)
            
        case "xrp-testnet":
            url = URL(string: "https://s.altnet.rippletest.net:51234")!
            let jsonBody: [String: Any] = ["method": "submit", "params": [["tx_blob": signedTx]]]
            body = try JSONSerialization.data(withJSONObject: jsonBody)
        ...
        if ["bitcoin", "bitcoin-mainnet", "bitcoin-testnet", "litecoin"].contains(chainId) {
