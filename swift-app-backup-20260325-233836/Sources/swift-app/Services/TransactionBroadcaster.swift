...
final class TransactionBroadcaster: ObservableObject {
    ...
    private func getRPCEndpoint(for chainId: Int) -> String {
        ...
        case 250: return "https://rpcapi.fantom.network"
    ...
    private func getRPCEndpoints(for chainId: Int) -> [String] {
        ...
        case 42161:
            return ["https://arb1.arbitrum.io/rpc", "https://rpc.ankr.com/arbitrum", "https://arbitrum.llamarpc.com"]
        case 10:
            return ["https://mainnet.optimism.io", "https://rpc.ankr.com/optimism", "https://optimism.llamarpc.com"]
        case 8453:
            return ["https://mainnet.base.org", "https://base.llamarpc.com", "https://rpc.ankr.com/base"]
        case 43114:
            return ["https://api.avax.network/ext/bc/C/rpc", "https://rpc.ankr.com/avalanche", "https://avalanche.llamarpc.com"]
        case 250:
            return ["https://rpcapi.fantom.network", "https://rpc.ankr.com/fantom", "https://fantom.llamarpc.com"]
        case 100:
            return ["https://rpc.gnosischain.com", "https://rpc.ankr.com/gnosis", "https://gnosis.llamarpc.com"]
        case 534352:
            return ["https://rpc.scroll.io", "https://rpc.ankr.com/scroll", "https://scroll.llamarpc.com"]
        default:
    ...
    private func getExplorerInfo(for chainId: Int) -> (baseURL: String, chainName: String) {
        ...
        case 42161: return ("https://arbiscan.io/tx/", "arbitrum")
        case 10: return ("https://optimistic.etherscan.io/tx/", "optimism")
        case 8453: return ("https://basescan.org/tx/", "base")
        case 43114: return ("https://snowtrace.io/tx/", "avalanche")
        case 250: return ("https://ftmscan.com/tx/", "fantom")
        case 100: return ("https://gnosisscan.io/tx/", "gnosis")
        case 534352: return ("https://scrollscan.com/tx/", "scroll")
    ...
    func checkLitecoinStatus(txid: String) async throws -> TransactionStatus {
        let baseURL = "https://litecoinspace.org/api"
        ...
        if let status = json["status"] as? [String: Any],
           ...
           confirmed {
            if let blockHeight = status["block_height"] as? Int {
                let currentHeight = try await getCurrentLitecoinBlockHeight()
                let confirmations = currentHeight - blockHeight + 1
                return .confirmed(confirmations: max(1, confirmations))
            }
            return .confirmed(confirmations: 1)
    ...
    private func getCurrentLitecoinBlockHeight() async throws -> Int {
        guard let url = URL(string: "https://litecoinspace.org/api/blocks/tip/height") else {
            throw BroadcastError.invalidURL
        }
    ...
    private func checkGenericEVMStatus(txid: String, rpcEndpoints: [String]) async throws -> TransactionStatus {
        var lastError: Error = BroadcastError.allEndpointsFailed
    ...
    func checkTransactionStatus(txid: String, chainId: String) async throws -> TransactionStatus {
        ...
        case "litecoin":
            return try await checkLitecoinStatus(txid: txid)
        ...
        case "bnb", "bsc-mainnet":
            return try await checkGenericEVMStatus(txid: txid, rpcEndpoints: [
                "https://bsc-dataseed.binance.org",
                "https://bsc-dataseed1.defibit.io",
