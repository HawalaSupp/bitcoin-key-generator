...
final class TransactionConfirmationTracker: ObservableObject {
    ...
    struct TrackedTransaction: Identifiable, Equatable {
        ...
        var isConfirmed: Bool {
            switch chainId {
            case "bitcoin", "bitcoin-mainnet", "litecoin":
                return confirmations >= 6
            case "bitcoin-testnet":
                return confirmations >= 1
            case "ethereum", "ethereum-mainnet", "bnb", "bsc-mainnet",
                 "arbitrum", "arbitrum-mainnet", "optimism", "optimism-mainnet",
                 "base", "base-mainnet", "avalanche", "avalanche-mainnet",
                 "fantom", "fantom-mainnet", "gnosis", "gnosis-mainnet",
                 "scroll", "scroll-mainnet":
                return confirmations >= 12
            case "polygon", "polygon-mainnet":
                return confirmations >= 20
        ...
        var confirmationProgress: Double {
            let required: Int
            switch chainId {
            case "bitcoin", "bitcoin-mainnet", "litecoin": required = 6
            case "bitcoin-testnet", "ethereum-sepolia": required = 1
            case "polygon", "polygon-mainnet": required = 20
            case "ethereum", "ethereum-mainnet", "bnb", "bsc-mainnet",
                 "arbitrum", "arbitrum-mainnet", "optimism", "optimism-mainnet",
                 "base", "base-mainnet", "avalanche", "avalanche-mainnet",
                 "fantom", "fantom-mainnet", "gnosis", "gnosis-mainnet",
                 "scroll", "scroll-mainnet": required = 12
            default: required = 1
            }
        ...
        var requiredConfirmations: Int {
            switch chainId {
            case "bitcoin", "bitcoin-mainnet", "litecoin": return 6
            ...
            case "ethereum", "ethereum-mainnet", "bnb", "bsc-mainnet",
                 ...
                 "base", "base-mainnet", "avalanche", "avalanche-mainnet",
                 "fantom", "fantom-mainnet", "gnosis", "gnosis-mainnet",
                 "scroll", "scroll-mainnet": return 12
            default: return 1
            }
        }
    }
    ...
    private func checkTransaction(txid: String, chainId: String) async {
        ...
        case "ethereum", "ethereum-mainnet", "ethereum-sepolia", "bnb", "bsc-mainnet",
