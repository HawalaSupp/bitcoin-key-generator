...
public final class HawalaBridge: @unchecked Sendable {
    ...
    public enum NoteCategory: String, Codable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            let legacyAssetType = "n" + "f" + "t"
            let legacyCollectionType = "collect" + "ible"
            ...
            case "airdrop": self = .airdrop
            case "stake": self = .stake
            case "unstake": self = .unstake
            case "gas": self = .gas
            case "fee": self = .fee
            case legacyCollectionType: self = .asset
            case legacyAssetType: self = .asset
            default: self = .other
            }
        }
