...
final class ChainAddressValidator: ObservableObject {
    ...
    func validate(address: String, chainId: String) async -> ChainAddressValidationResult {
        ...
        case "bitcoin", "bitcoin-mainnet":
            return validateBitcoinAddress(trimmed, isTestnet: false)
        case "bitcoin-testnet":
            return validateBitcoinAddress(trimmed, isTestnet: true)
        case "litecoin":
        ...
        case "polygon-mainnet", "bsc-mainnet",
             "arbitrum", "optimism", "base", "avalanche",
             "fantom", "gnosis", "scroll":
            // All EVM chains use the same 0x address format
            return validateEthereumAddress(trimmed)
    ...
    func isValidFormat(address: String, chainId: String) -> Bool {
        ...
        switch chainId.lowercased() {
        case "bitcoin", "bitcoin-mainnet":
            return isValidBitcoinFormat(trimmed, isTestnet: false)
        case "bitcoin-testnet":
            return isValidBitcoinFormat(trimmed, isTestnet: true)
        case "litecoin":
    ...
    private func isDomainName(_ input: String) -> Bool {
        ...
        // Unstoppable Domains (.crypto, .x, .wallet, .blockchain, .bitcoin)
        let unstoppableTLDs = [".crypto", ".x", ".wallet", ".blockchain", ".bitcoin", ".dao", ".888"]
    ...
    private func resolveENS(_ domain: String, chainId: String) async -> ChainAddressValidationResult {
        ...
        let supportedEVMChains: Set<String> = [
        ...
        guard supportedEVMChains.contains(chainId.lowercased()) else {
    ...
    private func resolveSolanaNS(_ domain: String, chainId: String) async -> ChainAddressValidationResult {
        ...
        guard ["solana", "solana-mainnet", "solana-devnet"].contains(chainId.lowercased()) else {
