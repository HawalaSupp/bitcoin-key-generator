...
final class TransactionCancellationManager: ObservableObject {
    ...
    private let supportedEVMChains: Set<String> = [
    ...
    func canCancel(txid: String, chainId: String) -> (canCancel: Bool, reason: String) {
        ...
        if let tx = cancellableTxs[txid] {
            ...
            case _ where supportedEVMChains.contains(chainId):
                if tx.nonce != nil {
        ...
        if supportedEVMChains.contains(chainId) {
    ...
    private func getChainId(for chainId: String) -> Int {
        switch chainId {
        case "ethereum", "ethereum-mainnet": return 1
        case "ethereum-sepolia": return 11155111
        case "bnb", "bsc-mainnet": return 56
        case "polygon", "polygon-mainnet": return 137
        case "arbitrum", "arbitrum-mainnet": return 42161
        case "optimism", "optimism-mainnet": return 10
        case "base", "base-mainnet": return 8453
        case "avalanche", "avalanche-mainnet": return 43114
        case "fantom", "fantom-mainnet": return 250
        case "gnosis", "gnosis-mainnet": return 100
        case "scroll", "scroll-mainnet": return 534352
        default: return 1
        }
    }
    ...
    private func getRPCURL(for chainId: String) -> String {
        switch chainId {
        case "ethereum", "ethereum-mainnet": return "https://eth.llamarpc.com"
        case "ethereum-sepolia": return "https://ethereum-sepolia-rpc.publicnode.com"
        case "bnb", "bsc-mainnet": return "https://bsc-dataseed.binance.org/"
        case "polygon", "polygon-mainnet": return "https://polygon-rpc.com"
        case "arbitrum", "arbitrum-mainnet": return "https://arb1.arbitrum.io/rpc"
        case "optimism", "optimism-mainnet": return "https://mainnet.optimism.io"
        case "base", "base-mainnet": return "https://mainnet.base.org"
        case "avalanche", "avalanche-mainnet": return "https://api.avax.network/ext/bc/C/rpc"
        case "fantom", "fantom-mainnet": return "https://rpcapi.fantom.network"
        case "gnosis", "gnosis-mainnet": return "https://rpc.gnosischain.com"
        case "scroll", "scroll-mainnet": return "https://rpc.scroll.io"
