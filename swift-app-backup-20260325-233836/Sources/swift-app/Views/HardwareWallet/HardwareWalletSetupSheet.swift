                ...
                ScrollView {
                    VStack(spacing: HawalaTheme.Spacing.xl) {
                        ...
                        VStack(spacing: HawalaTheme.Spacing.md) {
                            ...
                            Button {
                                viewModel.errorMessage = "The address shown on your device did not match the account Hawala derived. Reconnect the device, open the correct app, and verify the derivation path before trying again."
