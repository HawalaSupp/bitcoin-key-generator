...
enum LoadingCopy {
    ...
    static let assets        = "Loading asset details…"
    static let bitcoinExtras = "Checking Bitcoin activity…"
...
enum EmptyStateCopy {
    ...
    static let customAssets = Content(
        icon: "photo.on.rectangle.angled",
        title: "No Custom Assets Yet",
        message: "Add supported token contracts to track more assets.",
        cta: nil
    )
    ...
    static let bitcoinExtras = Content(
        icon: "bitcoinsign.circle",
        title: "No Additional Bitcoin Data",
        message: "This wallet currently focuses on core Bitcoin balances and activity.",
        cta: nil
    )
