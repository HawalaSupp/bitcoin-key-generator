...
final class BalanceResponseParserTests: XCTestCase {
    func testParseAlchemyETHBalance() throws {
    ...
    XCTAssertEqual(decimal, Decimal(string: "0.001")!, "Expected 0.001 ETH")
    }
    
    func testParseAlchemyERC20Balance() throws {
    ...
    XCTAssertEqual(decimal, Decimal(string: "2")!)
    }
    
    func testParseBlockchairETHBalance() throws {
    ...
    XCTAssertEqual(decimal, Decimal(string: "0.1")!)
    }
    
    func testParseBlockchairERC20Balance() throws {
    ...
    XCTAssertEqual(decimal, Decimal(string: "2.5")!)
    }
    
    func testParseXRPLBalance() throws {
    ...
    XCTAssertEqual(decimal, Decimal(string: "1.234567")!)
    }
}
